...
// Draft endpoints
pub const DRAFT_TRACKER_NOW_API_URL: &str = "https://api-web.nhle.com/v1/draft-tracker/now";
pub const DRAFT_PICKS_NOW_API_URL: &str = "https://api-web.nhle.com/v1/draft-picks/now";
pub const DRAFT_PICKS_API_URL: &str = "https://api-web.nhle.com/v1/draft-picks/{year}";
...
pub const POSTAL_CODE_API_URL: &str = "https://api-web.nhle.com/v1/postal-code/{code}";
...
pub fn get_url_template(data_type: &str, endpoint: &str) -> Option<&'static str> {
    match (data_type, endpoint) {
        ...
        // Misc
        ("misc", "postal_code") => Some(POSTAL_CODE_API_URL),
